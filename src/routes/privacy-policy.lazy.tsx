			...
			<Card className="prose dark:prose-invert">
				...
				<CardContent>
					<Callout className="py-1">
						<div>
							...
							<p className="mt-0">
								...
								your friends, but you don&apos;t have to use your real name or
								pic, of course. The cards you create are also public, because we
								are crowd-sourcing these flash cards for the benefit of all, so
								don&apos;t put private data in them please.
							</p>
							<p className="mt-0">
								We have not yet implemented GDPR-compliance features like the
								&ldquo;forget me&rdquo; feature, so if you are in the European
								Union please do not use our service.
							</p>
						</div>
					</Callout>
					...
					<ul>
						...
						<li>
							<p>
								<strong>Application</strong> refers to Sunlo, the software
						...
						<li>
							<p>
								...
								Entity&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;
								in this Agreement) refers to Sunlo.
							</p>
						</li>
						<li>
							<p>
						...
						<li>
							<p>
								...
								to third-party companies or individuals employed by the Entity
								to facilitate the Service, to provide the Service on behalf of
								the Entity, to perform services related to the Service or to
								assist the Entity in analyzing how the Service is used.
							</p>
						</li>
						<li>
							<p>
					...
					<ul>
						...
						<li>
							...
							gifs) that permit the Entity, for example, to count users who have
					...
					<p>
						The Entity will also retain Usage Data for internal analysis
